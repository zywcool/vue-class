...
<style>
	...
	.top-bar .top-bar-icon-back {
		position: absolute;
		width: .8rem;
		height: .88rem;
	}
	
	.top-bar .top-bar-icon-back span {
	...
	.top-bar .top-bar-new-shortcut>span {
		display: inline-block;
		margin: .24rem .24rem .24rem .20rem;
		width: .4rem;
		height: .4rem;
	...
	.top-bar .top-bar-new-shortcut .mask {
		position: fixed;
		left: 0;
		right: 0;
		top: 0;
	...
	.top-bar .top-bar-new-shortcut ul {
		position: absolute;
		top: 1.06rem;
		right: .2rem;
		border-radius: .08rem;
	...
	.top-bar .top-bar-new-shortcut ul li {
		display: block;
		position: relative;
		margin-left: .8rem;
	...
	.top-bar .top-bar-new-shortcut ul li span {
		position: absolute;
		top: 0;
		left: -0.8rem;
		width: 0.8rem;
	...
	.top-bar .top-bar-new-shortcut ul li a {
		display: block;
		border: 0;
		width: 100%;
		font-size: 0.28rem;
